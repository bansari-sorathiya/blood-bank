...
<body>
  <header class="header bg-light" style="position: sticky;top: 0; z-index: 10;">
              ...
              <div class="collapse navbar-collapse" id="navbarsExample07XL" style="margin:0 20% 0 20%;">
                  <ul class="navbar-nav mb-lg-2">
                      <li class="nav-item ms-4 me-4">
                          <a class="nav-link fw-bold" id="item" style=" margin-left:100px;"
                              target="_self" href='./index.php'>Home</a>
                      </li>
                      <li class="nav-item ms-4 me-4">
                          <a class="nav-link fw-bold" id="item" href='./request_blood.php' target="_self">Request</a>
                      </li>
                      <li class="nav-item ms-2 me-2">
                          <a class="nav-link fw-bold" id="item" href='' target="_self">Donate</a>
                      </li>
                      <li class="nav-item ms-2 me-2">
                          <a class="nav-link fw-bold" id="item" href='' style="text-wrap: nowrap;"
                              target="_self">FAQs</a>
                      </li>
                      <li class="nav-item ms-2 me-2">
                          <a class="nav-link fw-bold" id="item" href='' style="text-wrap: nowrap;"
                    ...
                    aria-expanded='false' style='border: hidden; background-color: #F8F9FA; display: flex;background-color: beige;'>";
                        echo"<i class='fa fa-user-circle me-2' style='font-size:22px; font-weight:600;color:#B47734;'></i> 
                        " . $user["name"] . "</button>

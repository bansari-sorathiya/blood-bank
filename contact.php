...
<head>
	...
	<!-- Style-CSS -->
	<link rel="stylesheet" href="../../BDMS/bbdms/css/fontawesome-all.css">
...
<body>
 <?php include('./header2.php');?> 
	...
	<!-- fixed navigation -->
	<script src="../../BDMS/bbdms/js/fixed-nav.js"></script>
	<!-- //fixed navigation -->

	<!-- smooth scrolling -->
	<script src="../../BDMS/bbdms/js/SmoothScroll.min.js"></script>
	<!-- move-top -->
	<script src="../../BDMS/bbdms/js/move-top.js"></script>
	<!-- easing -->
	<script src="../../BDMS/bbdms/js/easing.js"></script>
	<!--  necessary snippets for few javascript files -->
	<script src="../../BDMS/bbdms/js/medic.js"></script>

	<script src="../../BDMS/bbdms/js/bootstrap.js"></script>
